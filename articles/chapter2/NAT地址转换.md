# NAT——你家Wi-Fi下所有设备共享一个公网IP，路由器怎么知道该转发给哪台设备？

![配图](../../images-new/chapter2/nat-translation.png)
...
TCP的NAT超时虽然长（2-4小时），但有些防火墙的"空闲连接"超时更短（15-30分钟）。这就是为什么TCP长连接也需要心跳——不是为了保活TCP连接本身，而是为了防NAT/防火墙清除映射。
