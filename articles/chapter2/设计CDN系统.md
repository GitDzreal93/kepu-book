# 设计一个CDN——你的视频需要在全球范围毫秒级加载，边缘节点怎么设计？

![配图](../../images-new/chapter2/cdn-design.png)
...
> CDN的本质是"把内容推到离用户最近的地方"——通过边缘缓存+智能调度+回源机制三层架构，让全球用户都能毫秒级获取内容。设计CDN的核心挑战不是"存副本"（那只是复制文件），而是缓存命中率优化、调度准确性和缓存一致性的平衡——命中率决定性能，调度决定体验，一致性决定正确性。
