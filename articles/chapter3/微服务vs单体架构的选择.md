# 微服务vs单体——10人团队维护20个微服务，是不是有病

![配图](../../images-new/chapter3/microservice-vs-monolith.png)
...
1. **微服务不是"架构更先进"，而是"匹配组织复杂度的工具"**。康威定律说系统设计会反映组织结构——大公司的多团队结构自然催生微服务，小团队用微服务是自找麻烦。
...
4. **先拆"最独立、改动最频繁、压力最大"的服务**。不是一下子全拆，而是按优先级逐个拆。
