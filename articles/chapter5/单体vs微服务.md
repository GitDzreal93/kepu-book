# 单体架构比微服务差吗？——复杂度不会消失，只是转移了

![配图](../../images-new/chapter5/monolith-vs-microservice.png)
...
2. **选择的标准不是"趋势"，是"收益是否大于代价"**——10人团队做微服务是自残
...
> 微服务把代码的复杂度变成了运维的复杂度。10人团队的微服务不是前沿架构——是被未来的自己恨死的技术债。
