# CI/CD流水线设计：从代码提交到自动部署的完整链路

![](../../images-new/chapter5/cicd-pipeline.png)
...
**CI/CD不是逼你多干活，而是为你的那台机器"辩护"：它不能成为唯一的真理来源。**
...
> CI/CD把"在我机器上能跑"这句话从托辞变成了笑话。它不是逼你承认自己的机器有问题，而是让你的机器不再需要成为真理来源。
